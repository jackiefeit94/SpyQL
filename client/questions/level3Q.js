const level3Q = [
  {
    ...
    plotAnswer: '8',
    hint: `select * from alibis inner join suspects on suspects.alibiId = alibis.id;`,
  ...
  },
  {
    ...
    hint: `select guests.first_name, guests.last_name, guests.id from guests left join suspects on guests.suspectId = suspects.id;`,
    successText: "Well done, Agent. Let's take a closer look at that list..."
  },
  {
    //find who invited whom
    prompt:
      'It looks like most guests brought a date. Someone to confirm their alibi, perhaps? We should see if there is a way to display all guests and their dates.',
